                        ...
                        <div className='max-w-4xl mx-auto my-auto flex justify-center items-center'>
                            <div className='w-full'>
                                <HeadingComponent
                                    ...
                                    className="font-bold text-xl xmd:text-3xl xmd:mb-2 md:text-4xl"
                                />
                                <div className='font-semibold text-sm xmd:text-md xmd:mb-1 md:text-lg'>
                                    <Paragraph
                                        content={item.title}
                                    />
                                    <Paragraph
                                ...
                                <ButtonComponent
                                    content={item.button}
                                    size="sm"
                                    className="bg-slate text-zinc font-bold rounded-full"
                                />
                            </div>
                            <div className='w-full'>
                                <ImageComponent
